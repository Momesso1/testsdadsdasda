...
.. warning::
   Este código é legado. A versão seguinte (v1.1) lida com validação de IK e se comunica de forma mais simples com os nós que fazem o caminho.
